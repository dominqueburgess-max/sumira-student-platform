...
export function StudentOrientationVideo({ alreadyWatched }: { alreadyWatched: boolean }) {
  ...
  async function markWatched() {
    ...
    setError("");
    try {
      const res = await fetch("/api/student/orientation-watched", { method: "POST" });
    ...
    <div>
      <div className="rounded-2xl overflow-hidden border border-border bg-charcoal">
        <video
          ...
          onEnded={markWatched}
        >
          <source src="/videos/student-orientation.mp4" type="video/mp4" />
