...
((SELECT id FROM units WHERE title='Counting & Cardinality' AND course_id=(SELECT id FROM courses WHERE slug='math-k')), 'Counting to 10', 1, 'lesson',
'# Counting to 10
...
((SELECT id FROM units WHERE title='Counting & Cardinality' AND course_id=(SELECT id FROM courses WHERE slug='math-k')), 'How Many Are There?', 2, 'lesson',
'# How Many Are There?
...
((SELECT id FROM units WHERE title='Counting & Cardinality' AND course_id=(SELECT id FROM courses WHERE slug='math-k')), 'More or Fewer', 3, 'lesson',
'# More or Fewer
...
INSERT INTO lessons (unit_id, title, position, content_type, content_body, standards_code, standards_description, estimated_minutes) VALUES
((SELECT id FROM units WHERE title='Shapes Around Us' AND course_id=(SELECT id FROM courses WHERE slug='math-k')), 'Circles, Squares, and Triangles', 1, 'lesson',
...
((SELECT id FROM units WHERE title='Shapes Around Us' AND course_id=(SELECT id FROM courses WHERE slug='math-k')), 'Building with Shapes', 2, 'lesson',
...
INSERT INTO lessons (unit_id, title, position, content_type, content_body, standards_code, standards_description, estimated_minutes) VALUES
((SELECT id FROM units WHERE title='Addition & Subtraction Stories' AND course_id=(SELECT id FROM courses WHERE slug='math-1')), 'Joining Groups Together', 1, 'lesson',
...
((SELECT id FROM units WHERE title='Addition & Subtraction Stories' AND course_id=(SELECT id FROM courses WHERE slug='math-1')), 'Taking Away', 2, 'lesson',
'# Taking Away
...
'NC.1.OA.1', 'Use addition and subtraction within 20 to solve word problems.', 10),
((SELECT id FROM units WHERE title='Addition & Subtraction Stories' AND course_id=(SELECT id FROM courses WHERE slug='math-1')), 'Finding the Missing Number', 3, 'lesson',
...
INSERT INTO lessons (unit_id, title, position, content_type, content_body, standards_code, standards_description, estimated_minutes) VALUES
((SELECT id FROM units WHERE title='Place Value to 100' AND course_id=(SELECT id FROM courses WHERE slug='math-2')), 'Tens and Ones', 1, 'lesson',
'# Tens and Ones
...
((SELECT id FROM units WHERE title='Place Value to 100' AND course_id=(SELECT id FROM courses WHERE slug='math-2')), 'Adding Two-Digit Numbers', 2, 'lesson',
...
INSERT INTO lessons (unit_id, title, position, content_type, content_body, standards_code, standards_description, estimated_minutes) VALUES
((SELECT id FROM units WHERE title='Letters & Sounds' AND course_id=(SELECT id FROM courses WHERE slug='ela-k')), 'The Sound of "M"', 1, 'lesson',
'# The Sound of "M"
...
((SELECT id FROM units WHERE title='Letters & Sounds' AND course_id=(SELECT id FROM courses WHERE slug='ela-k')), 'Rhyming Words', 2, 'lesson',
'# Rhyming Words
...
((SELECT id FROM units WHERE title='Letters & Sounds' AND course_id=(SELECT id FROM courses WHERE slug='ela-k')), 'My First Sentence', 3, 'lesson',
'# My First Sentence
...
INSERT INTO lessons (unit_id, title, position, content_type, content_body, standards_code, standards_description, estimated_minutes) VALUES
((SELECT id FROM units WHERE title='Blending Words' AND course_id=(SELECT id FROM courses WHERE slug='ela-1')), 'Blending Sounds Into Words', 1, 'lesson',
...
((SELECT id FROM units WHERE title='Blending Words' AND course_id=(SELECT id FROM courses WHERE slug='ela-1')), 'Reading a Short Story', 2, 'lesson',
...
INSERT INTO lessons (unit_id, title, position, content_type, content_body, standards_code, standards_description, estimated_minutes) VALUES
((SELECT id FROM units WHERE title='Reading for Meaning' AND course_id=(SELECT id FROM courses WHERE slug='ela-2')), 'Finding the Main Idea', 1, 'lesson',
...
((SELECT id FROM units WHERE title='Reading for Meaning' AND course_id=(SELECT id FROM courses WHERE slug='ela-2')), 'Writing My Own Story', 2, 'lesson',
