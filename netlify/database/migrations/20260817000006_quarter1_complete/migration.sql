...
((SELECT id FROM lessons WHERE title='Counting to 10' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What number comes after 9?', '["8", "10", "11"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Counting to 10' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Count 10 things in your kitchen.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Matching Sets to Numbers' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which number matches a group of 4 apples?', '["2", "4", "7"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Matching Sets to Numbers' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Make a group of 3 objects and find the number 3 somewhere.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Big and Small' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which is usually bigger?', '["A dog", "A mouse", "An ant"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Big and Small' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Name one big thing and one small thing you can see right now.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Sorting by Color and Shape' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What is one way we sorted our toys?', '["By color", "By loudness", "By smell"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Sorting by Color and Shape' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Sort a group of toys at home and describe how you sorted them.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Rhyming Fun' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which word rhymes with ''bug''?', '["Rug", "Dog", "Cat"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Rhyming Fun' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Sing a rhyming song and name two words that rhyme.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Clapping Syllables' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'How many claps (syllables) are in the word ''dog''?', '["1", "2", "3"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Clapping Syllables' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Clap the syllables in your name. How many did you count?', NULL, NULL),
((SELECT id FROM lessons WHERE title='The Alphabet Song' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What letter comes right after B in the alphabet?', '["A", "C", "D"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='The Alphabet Song' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Sing the ABC song to a grown-up.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Retelling with Puppets' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What can help you act out a story?', '["Puppets or toys", "Closing the book", "Turning off the lights"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Retelling with Puppets' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Act out a story using toys. What story did you choose?', NULL, NULL),
((SELECT id FROM lessons WHERE title='Counting to 20' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What number comes right after 19?', '["18", "20", "21"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Counting to 20' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Count out loud from 1 to 20 to a grown-up.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Which Number is Greater?' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which number is greater: 8 or 5?', '["5", "8", "They are equal"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Which Number is Greater?' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Pick two numbers and tell which one is greater.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Positions: Above, Below, Beside' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'If a toy is under the table, where is it?', '["Above the table", "Below the table", "Beside the table"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Positions: Above, Below, Beside' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Find something in your room that is beside you.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Counting to 120' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What number comes right after 99?', '["100", "199", "90"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Counting to 120' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Start at any number and count forward 10 numbers.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Comparing Two-Digit Numbers' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which symbol makes this true: 27 __ 41?', '["<", ">", "="]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Comparing Two-Digit Numbers' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Pick two two-digit numbers and compare them using words ''greater than'' or ''less than.''', NULL, NULL),
((SELECT id FROM lessons WHERE title='Ten More, Ten Less' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What is 10 more than 34?', '["24", "44", "35"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Ten More, Ten Less' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Pick a two-digit number and find 10 more and 10 less than it.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Fact Families' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'If 6 + 3 = 9, what is another fact in that family?', '["9 - 3 = 6", "6 + 6 = 12", "3 + 3 = 6"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Fact Families' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Make your own fact family using three numbers.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Understanding Hundreds, Tens, and Ones' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'How many hundreds are in the number 342?', '["2", "3", "4"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Understanding Hundreds, Tens, and Ones' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Break apart a three-digit number into hundreds, tens, and ones.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Comparing Three-Digit Numbers' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which number is greater: 452 or 398?', '["398", "452", "They are equal"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Comparing Three-Digit Numbers' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Compare two three-digit numbers and explain how you knew which was greater.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Skip Counting to 1000' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What comes next when counting by 100s: 300, 400, ___?', '["410", "500", "450"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Skip Counting to 1000' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Practice counting by 5s up to 50 with a grown-up.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Adding Three-Digit Numbers' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What is 234 + 152?', '["286", "386", "486"]'::jsonb, 1),
((SELECT id FROM lessons WHERE title='Adding Three-Digit Numbers' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Solve 421 + 358 and show your steps.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Letter Sounds A-M Review' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What sound does the letter ''B'' make?', '["/b/", "/d/", "/m/"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Letter Sounds A-M Review' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Say three words that start with letters between A and M.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Letter Sounds N-Z Review' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What sound does the letter ''S'' make?', '["/s/", "/z/", "/t/"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Letter Sounds N-Z Review' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Say three words that start with letters between N and Z.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Blending Onset and Rime' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What word do you get when you blend /h/ + ''at''?', '["Hat", "Cat", "Mat"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Blending Onset and Rime' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Try blending /s/ + ''un.'' What word did you make?', NULL, NULL),
((SELECT id FROM lessons WHERE title='Writing the Alphabet' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Where should you usually start writing a letter?', '["At the top", "At the bottom", "In the middle"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Writing the Alphabet' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Practice writing three letters and show a grown-up.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Reading Sight Words Set 1' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which of these is a sight word we practiced?', '["said", "elephant", "birthday"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Reading Sight Words Set 1' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Find a sight word in a book and point to it.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Reading Sight Words Set 2' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which of these is a sight word we practiced?', '["they", "dinosaur", "computer"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Reading Sight Words Set 2' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Use one of the new sight words in a sentence.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Understanding Story Problems and Solutions' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What is a ''problem'' in a story?', '["Something the character needs to solve", "The title of the book", "The last page"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Understanding Story Problems and Solutions' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Name a problem and solution from a story you''ve read.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Sequencing Events in a Story' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'Which word helps tell what happens at the very beginning?', '["First", "Last", "Finally"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Sequencing Events in a Story' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Retell a story using the words first, next, and last.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Understanding Character Motivation' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What does ''motivation'' mean in a story?', '["The reason a character acts a certain way", "The title of the book", "The illustrator''s name"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Understanding Character Motivation' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Describe why a character in a story you read did something.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Identifying Theme' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What is a story''s ''theme''?', '["The big lesson or message", "The number of pages", "The author''s favorite color"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Identifying Theme' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Name a story and its theme or lesson.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Using Context Clues' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What are ''context clues''?', '["Words around an unknown word that help explain it", "The title of a book", "A type of punctuation"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Using Context Clues' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Find an unfamiliar word in a book and guess its meaning using context clues.', NULL, NULL),
((SELECT id FROM lessons WHERE title='Reading Fluently with Expression' ORDER BY id DESC LIMIT 1), 1, 'multiple_choice', 'What does it mean to read with ''expression''?', '["Using your voice to show feeling", "Reading as fast as possible", "Whispering the whole time"]'::jsonb, 0),
((SELECT id FROM lessons WHERE title='Reading Fluently with Expression' ORDER BY id DESC LIMIT 1), 2, 'short_answer', 'Read a short passage out loud with expression to a grown-up.', NULL, NULL);
